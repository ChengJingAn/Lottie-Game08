...
var audioJson = {
    bodyAudio: new loadSound('angry2'),
...
let animationData;
new loadAnimation('Shot_05/SB08_Comp_V3_shot_05_Angry.json').then(result => {
    animationData = result;
}, () => { });
var loadCount = 0;

export default function BaseScene({ nextFunc, _geo, _addSuccesslist, audioList, setVolume }) {
    ...
    useEffect(() => {
        ...
        audioList.audioBody.src = prePathUrl() + 'sounds/angry2.mp3';
    ...
    return (
        ...
        >
            ...
            >
                ...
                />
                < BaseImage
                    url={"Icons/SB08_Worried_Icon.svg"}
                    geo={_geo}
                    onLoad={loading}
                />
            </BaseProp>
