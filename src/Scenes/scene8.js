...
let animationData;
new loadAnimation('Shot_08/SB08_Comp_V3_shot_08_scared.json').then(result => {
    animationData = result;
}, () => { });

var audioJson = {

    bodyAudio: new loadSound('scared1')
}

const timerlist = []

export default function IntroScene({ nextFunc, _geo, showBear, hideBear, playBearAni, pauseBearAni, audioList }) {
    ...
    useEffect(() => {
        audioList.audioBody.src = prePathUrl() + 'sounds/scared1.mp3'
        ...
        <div className="aniObject">
            <div
                ...
                {/* <img
                    ...
                    width={"100%"}
                    src={prePathUrl() +"images/Icons/SB08_CI_Scared_Circle.svg"}
                /> */}
                <div
                    style={{
