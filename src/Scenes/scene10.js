...
var audioJson = {
    bodyAudio: new loadSound('happy2'),
    correctAudio: new loadSound('correct2'),
    errorAudio: new loadSound('tap_error'),
...
let animationData;
new loadAnimation('Shot_03/SB08_Comp_V3_Shot_03_happy.json').then(result => {
...
export default function BaseScene({ nextFunc, _geo, _addSuccesslist, audioList }) {
    ...
    useEffect(() => {
        ...
        audioList.audioSubBody2.src = audioJson.errorAudio.src;
        audioList.audioBody.src = prePathUrl() + 'sounds/happy2.mp3';
        ...
        return () => {
            clearTimerList([1, 2, 3, 4, 5, 6])
            audioList.audioBody.pause();
            audioList.audioSubBody1.pause();
            audioList.audioSubBody2.pause();
            ...
            audioList.audioSubBody2.currentTime = 0;
        }
    }, [])
