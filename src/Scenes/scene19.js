...
var audioJson = {
    bodyAudio: new loadSound('angry3'),
    correctAudio: new loadSound('angry3_true'),
...
export default function BaseScene({ nextFunc, _geo, _addSuccesslist, audioList }) {
    ...
    setTimeout(() => {
        if (isSelectedCorrect)
            refCorrect.current.scale({ s: 1.2, l: 0.29, t: 0.15, tran: '2.2s' });
    }, 100);
    ...
    return (
        ...
        >
            ...
            >
                ...
                < BaseImage
                    url={"Character/SB08_CI_Boy_with_broken_bat_Icon.svg"}
                    geo={_geo}
                    onLoad={loading}
                />
            </BaseProp>
            ...
            >
                ...
                < BaseImage
                    url={"Character/SB08_CI_Boy_painting_Icon.svg"}
                    geo={_geo}
                    onLoad={loading}
                />
            </BaseProp>
