...
var audioJson = {
    bodyAudio: new loadSound('worry3'),
    correctAudio: new loadSound('worry3_true'),
    ...
    return (
        ...
        >
            ...
            >
                ...
                < BaseImage
                    url={"Character/SB08_CI_Boy_broken_toy_Icon.svg"}
                    geo={_geo}
                    onLoad={loading}
                />
            </BaseProp>
            ...
            >
                ...
                < BaseImage
                    url={"Character/SB08_CI_Boy_going_school_Icon.svg"}
                    geo={_geo}
                    onLoad={loading}
                />
            </BaseProp>
