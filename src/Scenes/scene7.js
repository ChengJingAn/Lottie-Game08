...
let animationData;
new loadAnimation('Shot_07/SB08_Comp_V3_shot_07_worried.json').then(result => {
...
var audioJson = {
    bodyAudio: new loadSound('worry1')
}
...
export default function IntroScene({ nextFunc, _geo, playBearAni, pauseBearAni, showBear, audioList }) {
    ...
    useEffect(() => {
        audioList.audioBody.src = prePathUrl() + 'sounds/worry1.mp3'
        ...
        <div className="aniObject">
            <div
                ...
                {/* <img
                    ...
                    width={"100%"}
                    src={prePathUrl() +"images/Icons/SB08_CI_Worried_Circle.svg"}
                /> */}
                <div
                    style={{
