...
var audioJson = {
    bodyAudio: new loadSound('happy1')
}
...
export default function IntroScene({ nextFunc, _geo, showBear, playBearAni, pauseBearAni, audioList }) {
    ...
    useEffect(() => {
        ...
        audioList.audioBody.src = prePathUrl() + 'sounds/happy1.mp3'
        setStopAni(true)
        ...
        <div className="aniObject">
            ...
            <div
                ...
                {/* <img
                    ...
                    width={"100%"}
                    src={prePathUrl() +"images/Icons/SB08_CI_Happy_Circle.svg"}
                /> */}
                <div
                    style={{
