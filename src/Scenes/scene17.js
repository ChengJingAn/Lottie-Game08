...
var audioJson = {
    bodyAudio: new loadSound('happy3'),
    correctAudio: new loadSound('happy3_true'),
    ...
    return (
        ...
        >
            ...
            >
                ...
                < BaseImage
                    url={"Character/SB08_CI_Boy_with_ice-cream_Icon.svg"}
                    geo={_geo}
                    onLoad={loading}
                />
            </BaseProp>
            ...
            >
                ...
                < BaseImage
                    url={"Character/SB08_CI_Boy_with_dog_Icon.svg"}
                    geo={_geo}
                    onLoad={loading}
                />
            </BaseProp>
