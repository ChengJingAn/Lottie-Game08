...
var audioJson = {
    bodyAudio: new loadSound('angry1')
}
...
export default function IntroScene({ nextFunc, _geo, playBearAni, pauseBearAni, audioList }) {
    ...
    useEffect(() => {
        ...
        audioList.audioBody.src = prePathUrl() + 'sounds/angry1.mp3'
        ...
        <div className="aniObject">
            <div
                ...
                {/* <img
                    ...
                    width={"100%"}
                    src={prePathUrl() +"images/Icons/SB08_CI_Angry_Circle.svg"}
                /> */}
                <div
                    style={{
