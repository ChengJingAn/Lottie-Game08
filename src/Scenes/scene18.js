...
var audioJson = {
    bodyAudio: new loadSound('sad3'),
    correctAudio: new loadSound('sad3_true'),
    ...
    return (
        ...
        >
            ...
            >
                ...
                < BaseImage
                    url={"Character/SB08_CI_Girl_wonded_Icon.svg"}
                    geo={_geo}
                    onLoad={loading}
                />
            </BaseProp>
            ...
            >
                ...
                < BaseImage
                    url={"Character/SB08_CI_Boy_with_ball_Icon.svg"}
                    geo={_geo}
                    onLoad={loading}
                />
            </BaseProp>
